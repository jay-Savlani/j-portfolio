  ...
  return (
    <div className="pt-4 md:pt-8 overflow-hidden">
      <div className="h-auto sm:h-[80vh] py-8 md:py-0 flex flex-col-reverse md:flex-row ">
        <div className="flex flex-col justify-center h-full w-full md:w-3/4  lg:w-1/2 p-4">
          <div className="px-0 sm:px-8 text-center md:text-left">
            ...
            <h2 className="animation-fade-in font-semibold text-lg lg:text-[22px] tracking-wider mb-6   text-transparent bg-gradient-to-r from-yellow-300 to-yellow-500 bg-clip-text">
              SOFTWARE DEVELOPER
            </h2>
      ...
      <div className="px-3 mb-8 sm:mb-0 sm:px-0 py-4 sm:py-8 lg:py-20 flex  lg:flex-row sm:flex-col gap-6 sm:gap-14 flex-wrap items-center justify-center ">
        <p className="text-[100px] lg:text-[200px] text-transparent bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text animation-spin-slow">
          &lt;/&gt;
        </p>
        <code className="overflow-x-auto">
          <pre className="w-max py-3 text-sm sm:text-base lg:text-2xl text-transparent bg-gradient-to-r from-slate-200 to-slate-400 bg-clip-text">
            {init_life}
          </pre>
        </code>
      </div>
