...
export const projectsData: Partial<T_ProjectsData>[] = [
  {
    ...
    summary:
      "Code and unit test generation desktop tool driven by ChatGPT with code analysis, inbuilt code editor, generation history and file save functionality with servelerss AWS lambda api.",
    problemStatement: [
